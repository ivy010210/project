...
public class ChangePic extends AppCompatActivity {
        ...
        private int[] image = {
                ...
                R.drawable.umbrella,R.drawable.wallet,R.drawable.watch,R.drawable.water,R.drawable.eggs,R.drawable.minions,
                R.drawable.family,R.drawable.yellow
        };
        private String[] imgText = {
                ...
                ,"ticket","trainers","umbrella","wallet","watch","water","eggs","minions","family","yellow"
        };
        @Override
